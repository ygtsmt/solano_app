...
extension MediaQueryExtension on BuildContext {
  ...
  double get minHighValue => height * 0.04;

  /// Returns 5% of the screen height
  double get highValue => height * 0.05;

  /// Returns 7% of the screen height
  double get higherValue => height * 0.06;
...
extension PaddingExtension on BuildContext {
  ...
  EdgeInsets get paddingAllLowLeft => EdgeInsets.only(left: lowValue);
  ...
  /// Adds 2% padding from all sides.
  /// Use this when you want to add padding from all sides.
  EdgeInsets get paddingAllDefaultSymmetricHorizontal =>
